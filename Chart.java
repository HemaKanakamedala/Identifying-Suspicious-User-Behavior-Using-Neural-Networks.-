...
private static CategoryDataset createDataset(){
	...
	localDefaultCategoryDataset.addValue(NeuralNetwork.benign,"Benign Access","Benign Access");
	localDefaultCategoryDataset.addValue(NeuralNetwork.suspicious,"Suspicious Access","Suspicious Access");
...
private static JFreeChart createChart(CategoryDataset paramCategoryDataset){
	JFreeChart localJFreeChart = ChartFactory.createBarChart(title,"Access Type", "Count", paramCategoryDataset, PlotOrientation.VERTICAL, true, true, false);
